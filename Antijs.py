...
cl = LINE("EvrRz1Fqp3KTmQdo1fha.BCOJLXEpS5jes9iZKe+BQG.IszUEaw9hxAF34G8/vM3kIRXrkyOTSnBDvof1Y2EJ8I=")
ki = LINE("EvVBAkFhbsm4UUD089e3.Ga8PiNvc7hDADybeZ6xbiW.03fyQF6G0pqEP4ecYpxUOAU8h1dLTvdeUcGxMYdQY8A=")
kk = LINE("Evm2vrGwgIGxEQl2ipV4.0DGcqhrdeuUccgzgvzrHDa.uYf4+IsxDP3zsQG2WfU9zpEoWUEHXsLKrzio/b8rM/4=")
kc = LINE("EvFpzLcmdvO6HTeXWpr8.YLyJFJCAuRSyQTUKp6o2Aa.jC/5z56S1GpDvWE/J0GNjBM72VRgejiAe3VQTusPxp4=")
kb = LINE("EvePejtcaO540QTiya91.VDA1hE5jc0FFtUOPcLaKuq.hrE6uT6aNxvmg+PSyXmKBoFj2mD0pSoRd/G6hht9u9Y=")
sw = LINE("EvAtfgt5LlhBegPURzM3.Gw7RgzYQicN5bCB5AcUXWW.FV99C4UECq2Y/zgENPAtbEdh6AvlqX+2mUumxmh9OUU=")

print ("==========[ Success Login ]===========")

poll = OEPoll(cl)
call = (cl)
creator = ["u6dca2397178fb392444bd233904fdbaa"]
owner = ["u6dca2397178fb392444bd233904fdbaa"]
admin = ["u6dca2397178fb392444bd233904fdbaa"]
staff = ["u6dca2397178fb392444bd233904fdbaa"]
                    ...
                    if text is None:
                        ...
                        if cmd == "self on":
                          ...
                          if wait["selfbot"] == True:
                            ...
                            if msg._from in admin:
                                cl.sendMessage(msg.to,"Creator Bot Dd Bakpao") 
                                ma = ""
                                for i in creator:
                                    ma = cl.getContact(i)
                        ...
                        elif cmd == "Ddku" or text.lower() == 'mybot':
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               ...
                               cl.sendMessage(msg.to, "Iya Hadir Kakak Sayang")
